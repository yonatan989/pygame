...
# Fixed variables
MOVING_IMAGE = r'/usr/src/app/pictures/dod.png'
KING_IMAGE = r'/usr/src/app/pictures/dodKing.png'
Dynamic_king = r'/usr/src/app/pictures/dod_King/'
HART_IMAGE = r'/usr/src/app/pictures/hart.png'
BULLET = '/usr/src/app/pictures/bullet.png'
KING_DIR = r'/usr/src/app/pictures/dod_king'
DEVIL_IMAGE = r'/usr/src/app/pictures/Devils/Devil.png'
METEOR_IMAGE = r'/usr/src/app/pictures/Devils/meteor.png'
FLOWER_IMAGE = r'/usr/src/app/pictures/flowers.png'
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, x, y, isking=False, isMeteor=False, isflower=False):
        ...
        if (self.isking): # King object
            ...
            rndSlave = r'/usr/src/app/pictures/slaves/{0}.png'.format(rnd)
